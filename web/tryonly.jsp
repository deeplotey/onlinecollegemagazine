...
<!--start of division viewusers-->
      ...
      <% 
       ...
       PreparedStatement ps=con.prepareStatement("select * from userslist" );
   ...
   <!--Start of division viewarticles-->
       ...
       Class.forName("com.mysql.jdbc.Driver");
       Connection con1=DriverManager.getConnection("jdbc:mysql://localhost:3306/online_clg_mag","root","");
       PreparedStatement ps1=con1.prepareStatement("select * from viewarticles");
 ...
 <!--start of division viewfeedbacks-->
                   ...
                   <table border="0">
                   <thead>
                   <th>topic</th><th><input type="submit" value="remove" onclick="return deleteu();"/></th>
                   </thead>
                    <tbody>
      ...
      <%
       ...
       Class.forName("com.mysql.jdbc.Driver");
       Connection con2=DriverManager.getConnection("jdbc:mysql://localhost:3306/online_clg_mag","root","");
        ...
        <!--<td><div class="btn-group">
              ...
              <ul class="dropdown-menu">
                <li><input type="submit" class="btn btn-success" value="viewmore" onclick="return viewmore();"/></li>
                <li><i class="icon-trash"></i> <input type="submit" class="btn btn-success" value="removeit"/></li>
              </ul>
            </div></td>-->
        </tr><%
               }
